...
public class ZGuiScreen extends Screen {
	...
	private float[] player_exp_ratio = new float[6];
	 ...
	 { 
		    ...
		    //up
		    buf.func_225582_a_(x, y, 0).func_225586_a_(255, 255, 255,255).endVertex();
		    buf.func_225582_a_(x+RWidth, y, 0).func_225586_a_(255, 255, 255,255).endVertex();
		    
		    //down
		    buf.func_225582_a_(x, y+RHeight, 0).func_225586_a_(255, 255, 255,255).endVertex();
		    buf.func_225582_a_(x+RWidth, y+RHeight, 0).func_225586_a_(255, 255, 255,255).endVertex();
		    ...
		    buf.begin(1, DefaultVertexFormats.POSITION_COLOR);
		    buf.func_225582_a_(x+2F, y+2F, 0).func_225586_a_(255, 0, 0, 120).endVertex();
		    buf.func_225582_a_(x+RWidth-2F, y+2F, 0).func_225586_a_(255, 0, 0, 120).endVertex();
		    tessellator.draw();
		    ...
		    RenderSystem.lineWidth(RHeight - 1F);
		    buf.begin(1, DefaultVertexFormats.POSITION_COLOR);
		    buf.func_225582_a_(x+2F, y+2F, 0).func_225586_a_(0, 0, 255, 255).endVertex();
		    buf.func_225582_a_(x+(RWidth-2F)*player_exp_ratio[index], y+2F, 0).func_225586_a_(0, 0, 255, 255).endVertex();
		    tessellator.draw();
