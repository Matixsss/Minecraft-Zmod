...
public class ZRanking extends Screen {
	...
	private void createEntityToShow()
	 ...
	 public void drawEntityOnScreen(int posX, int posY, int scale, Entity e) {
	      ...
	      GlStateManager.rotatef(model_rotate, 0.0F, 1.0F, 0.0F);
    	  model_rotate += 0.1F;
	      ...
	      //rysuj postac
		  entityrenderermanager.renderEntity(e, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F, false); 	      
	      //koniec
	 ...
	 public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
	      ...
	      {	    	 
	    	  ...
	    	  {
	    		  if(e.getName().getUnformattedComponentText().equals("???")) {GlStateManager.color3f(0F, 0F, 0F);}	    		
